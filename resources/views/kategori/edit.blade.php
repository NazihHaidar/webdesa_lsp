...
<div class="container"><p>Tambahkan atau edit data kategori. Jika sudah selesai, jangan lupa untuk mengetik tombol
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <input id="id" type="text" class="form-control" value="{{ $id }}" readonly>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <input id="nama_kategori" type="text" class="form-control" name="nama_kategori" value="{{ $nama_kategori }}"
                required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <textarea id="keterangan" class="form-control" name="keterangan" rows="4"
